...
export default function FileBar(props: fileProps) {
  ...
  const videoRef1 = useRef<HTMLCanvasElement | any>(null);
  const videoRef2 = useRef<HTMLCanvasElement>(null);
  const videoRef3 = useRef<HTMLCanvasElement>(null);
  const videoRef4 = useRef<HTMLCanvasElement>(null);
          ...
          <div style={{ overflow: "auto", width: "100%", height: 450, maxHeight: 450, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            <div style={{ width: "75%", height: "40%", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              >
                ...
                {
                  props?.media[props.media.length - 1]?.type == "vid" &&
                  <PlayIcon></PlayIcon>
                }
              ...
              >
                {
                  props?.media[props.media.length - 2]?.type == "vid" &&
                  <PlayIcon></PlayIcon>
                }
              </Button>
            </div>
...
{
                  props?.media[props.media.length - 3]?.type == "vid" &&
                  <PlayIcon></PlayIcon>
                }
              ...
              >
                {
                  props?.media[props.media.length - 4]?.type == "vid" &&
                  <PlayIcon></PlayIcon>
                }
